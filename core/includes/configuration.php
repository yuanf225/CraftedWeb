		...
		<?php
			...
			$default_email = 'alexandreluisbarreto@gmail.com'; //The default email address from wich Emails will be sent.

			$website_domain = 'http://craftedweb'; //Provide the domain name AND PATH to your website.
			...
			$compression['gzip'] 				= false; //This is very hard to explain, but it may boost your website speed drastically.
