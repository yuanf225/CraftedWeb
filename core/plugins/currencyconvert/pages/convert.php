...
<?php echo DATA['website']['title']; ?> now lets you convert your Vote Points into <?php echo DATA['website']['donation']['coins_name']; ?>!<br/>
Every <?php echo $divide; ?>th Vote Point will give you 1 donation coin, simple! <br/>
You currently have 
<b>
    <?php echo $Account->loadVP($_SESSION['cw_user']); ?>
</b> 

Vote Points which would give you 

<b><?php echo floor($Account->loadVP($_SESSION['cw_user']) / $divide); ?></b>
...
<form action="?page=convert" method="post">
    ...
    if ( isset($_POST['convert']) )
    {
        ...
        else
        {
            ...
            $Account->logThis("Converted ". $vp ." Vote Points into ". $dp ." ". DATA['website']['donation']['coins_name'], "currencyconvert", NULL);
