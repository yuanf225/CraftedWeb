...
INSERT INTO `site_links` VALUES (1,'Home','?p=home','always'),(2,'Register','?p=register','notlogged'),(3,'My Account','?p=account','logged'),(4,'Vote','?p=vote','logged'),(5,'Donate','?p=donate','always'),(6,'Forum','/forum/','always');
